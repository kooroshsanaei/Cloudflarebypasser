...
def __start__():
    ...
    print(Fore.RED+""" [!] Welcome To The Z Cloudflare Bypasser Part 
 ...
 └──╼ """+Fore.WHITE+"=> ")
    ...
    for sub in subdom:
        try:
            ...
            print(Fore.GREEN+" [!]CloudFlare Bypass Found "+str(bypass) + ' | ' + str(hosts))
            bypass_id_list[str(hosts)] = str(bypass)
        except Exception:
            print(Fore.CYAN+str(hosts)+" Checked.")
            pass
    try:
        os.system('clear')
        for k, v in bypass_id_list.items():
            print( Fore.CYAN+k + " ==> "+ Fore.RED+ v)
